function loco() {
  ...
  // tell ScrollTrigger to use these proxy methods for the "#bottom" element since Locomotive Scroll is hijacking things
  ScrollTrigger.scrollerProxy("#bottom", {
    scrollTop(value) {
    ...
    pinType: document.querySelector("#bottom").style.transform
      ? "transform"
      : "fixed",
  });
